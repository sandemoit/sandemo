...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2023 at 08:34 PM
...
CREATE TABLE `blog` (
  ...
  `meta` varchar(140) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE `kandidat` (
  ...
  `date_birth` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Sandemo Indo Teknologi', '#1 Layanan Website Terbaik', 'Build your business through a digital marketing strategy with us! Make millions of people in the world discover your business.', 'Kami berfokus pada teknologi informasi dan multimedia. Kami siap memberikan solusi terbaik bagi Anda. Corporate, UMKM, hingga kolaborasi bisnis.', 'Gelumbang, Muara Enim, Palembang, Sumatera Selatan 31171 Indonesia', '6285380945896', 'sandemoindoteknologi', 'sandemoindoteknologi', 'office@sandemoindoteknologi.co.id', 'linkedin.com');
...
INSERT INTO `subscriber` (`id`, `email`, `nama`) VALUES
(19, 'infosandemo@gmail.com', 'Sandi Maulidika'),
(20, 'sandimaulidika@gmail.com', 'Sandi Maulidika');
