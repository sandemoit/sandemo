                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="error-wrapper text-center mb-30">
                            ...
                            <h2 class="error-title mb-25">404. Page not found</h2>
                            <p class="h6 fw-normal">Maaf, kami tidak bisa menemukan halaman yang Anda cari. Kami menyarankan agar Anda kembali ke home.</p>
                            <a href="<?= site_url('/') ?>" class="theme_btn"><i class="fal fa-long-arrow-left"></i> Go To
                                Homepage</a>
                        </div>
                    </div>
                </div>
