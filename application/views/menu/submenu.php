            ...
            <div class="d-lg-flex">
                ...
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                    <div class="ms-auto my-auto">
                        <a href="" class="btn waves-effect waves-light btn-primary" data-bs-toggle="modal" data-bs-target="#newsubmenumodal">+&nbsp; New Submenu</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form action="<?php echo base_url('admin/menu/subedit') ?>" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select name="menu_id" id="menu_id" class="form-control">
                                <?php foreach ($menu as $m) : ?>
                                    <option <?= $sm['menu_id'] == $m['id'] ? 'selected' : '' ?> value="<?= $m['id']; ?>"><?= $m['menu']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
