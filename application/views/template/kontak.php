<section class="contact-one">
    <div class="container wow fadeInUp" data-wow-duration="1500ms">
        <div class="inner-container">
            ...
            <img src="<?= base_url('assets/frontend') ?>/images/mocups/contact-1-moc-1.png" class="contact-one__shape-2" alt="">
            <img src="<?= base_url('assets/frontend') ?>/images/mocups/contact-1-moc-2.png" class="contact-one__shape-3" alt="">
