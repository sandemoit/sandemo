...
<head>
    <title><?= $home['judul_website'] ?> - <?= $home['slogan_website'] ?></title>
    <meta charset="UTF-8">
    ...
    <meta property="og:image" content="<?= base_url('assets/frontend/images/favicons/logo.png') ?>">
    <meta property="og:image:secure_url" content="<?= base_url('assets/frontend/images/favicons/logo.png') ?>">
    <meta property="article:author" content="Sandi Maulidika">
    <meta property="article:published_time" content="2022-09-15T11:31+07:00">
    <meta property="article:modified_time" content="2023-09-15T11:32+07:00">
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 1,
                "name": "HomePage",
                "item": "https://sandemoindoteknologi.co.id/"
            }]
        }
    </script>
