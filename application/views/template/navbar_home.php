<nav class="main-nav-one main-nav-one__home-three stricky">
    <div class="container-fluid">
        <div class="inner-container">
            <div class="logo-box">
                <a href="<?= site_url('') ?>">
                    <img src="<?= base_url('assets/frontend') ?>/images/sandemoid.png" aria-label="PT. Sandemo Indo Teknologi" width="100%">
                </a>
            ...
            <div class="main-nav__right">
                <a href="mailto:<?= $home['gmail'] ?>" aria-label="kirim email" class="main-nav__email"><i class="far fa-envelope"></i></a>
                <a href="<?= site_url('contact') ?>" class="thm-btn main-nav-one__btn"><span>GET IN TOUCH</span></a>
