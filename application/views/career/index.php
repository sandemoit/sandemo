        ...
        <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
                <div class="ms-auto my-auto">
                    <a href="<?= site_url('admin/page/addCareer') ?>" class="btn waves-effect waves-light btn-primary">+&nbsp; New Careers</a>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($careers as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key['limit_job'] ?></td>
                                <td>
                                    <a href="<?= site_url('admin/page/editCareer/') . $key['id'] ?>" class="btn btn-warning btn-icon-split">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn waves-effect waves-light btn-danger" href="<?= base_url('admin/page/deleteCareer/') . $key['id']; ?>">Delete</a>
                </div>
            </div>
        </div>
    </div>
